...
class Careerup_Elementor_Logo extends Widget_Base {

	public function get_name() {
        return 'careerup_logo';
    }

	public function get_title() {
        return esc_html__( 'Apus Header Logo', 'careerup' );
    }
...
if ( version_compare(ELEMENTOR_VERSION, '3.5.0', '<') ) {
    Plugin::instance()->widgets_manager->register_widget_type( new Careerup_Elementor_Logo );
} else {
    Plugin::instance()->widgets_manager->register( new Careerup_Elementor_Logo );
}