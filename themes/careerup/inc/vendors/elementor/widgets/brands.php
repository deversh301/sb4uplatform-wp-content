...
class Careerup_Elementor_Brands extends Widget_Base {

	public function get_name() {
        return 'careerup_brands';
    }

	public function get_title() {
        return esc_html__( 'Apus Brands', 'careerup' );
    }
	...
	protected function register_controls() {
        ...
        $repeater->add_control(
            'list_title', [
                ...
                'default' => esc_html__( 'Brand Title' , 'careerup' ),
                'label_block' => true,
            ]
        );
        ...
        $repeater->add_control(
            ...
            [
                'name' => 'image',
                'label' => esc_html__( 'Brand Image', 'careerup' ),
        ...
        $repeater->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::TEXT,
                'input_type' => 'url',
                'placeholder' => esc_html__( 'Enter your brand link here', 'careerup' ),
            ]
        );
        ...
        $this->add_control(
            'brands',
            [
                'label' => esc_html__( 'Brands', 'careerup' ),
                'type' => Controls_Manager::REPEATER,
                'placeholder' => esc_html__( 'Enter your brands here', 'careerup' ),
                        ...
                        <?php foreach ($brands as $brand) { ?>
                            ...
                            ?>
                                    <div class="brand-item col-md-<?php echo esc_attr($bcol); ?>">
                                        ...
                                        <?php } ?>
                                            <img src="<?php echo esc_url($img_src); ?>" <?php echo (!empty($brand['title']) ? 'alt="'.esc_attr($brand['title']).'"' : 'alt="'.esc_attr__('Image', 'careerup').'"'); ?>>
                                        <?php if ( !empty($brand['link']) ) { ?>
                                            </a>
                                        <?php } ?>
                                    </div>
...
if ( version_compare(ELEMENTOR_VERSION, '3.5.0', '<') ) {
    Plugin::instance()->widgets_manager->register_widget_type( new Careerup_Elementor_Brands );
} else {
    Plugin::instance()->widgets_manager->register( new Careerup_Elementor_Brands );
}