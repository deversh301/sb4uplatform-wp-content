...
$job_id = get_post_meta($post->ID, WP_JOB_BOARD_APPLICANT_PREFIX.'job_id', true);
            ...
            <div class="right-info ali-right hidden-xs">
                <div class="flex-middle">
                    <div class="applicant-action-button">
                        ...
                        ?>
                        <a href="javascript:void(0);" class="btn-approve-job-applied btn-action-icon btn-action-sm approve  <?php echo esc_attr($classes); ?>" data-applicant_id="<?php echo esc_attr($post->ID); ?>" data-nonce="<?php echo esc_attr(wp_create_nonce( 'wp-job-board-approve-applied-nonce' )); ?>" title="<?php echo esc_attr_e('Approve Application', 'careerup'); ?>"><i class="ti-check"></i></a>
                        
                        <a href="javascript:void(0);" class="btn-reject-job-applied btn-action-icon btn-action-sm reject <?php echo esc_attr($classes); ?>" data-applicant_id="<?php echo esc_attr($post->ID); ?>" data-nonce="<?php echo esc_attr(wp_create_nonce( 'wp-job-board-reject-applied-nonce' )); ?>" title="<?php echo esc_attr_e('Reject Application', 'careerup'); ?>"><i class="flaticon-close"></i></a>
    ...
    <div class="right-info bottom-info visible-xs">
        ...
        <div class="flex-middle">
            <div class="applicant-action-button">
                    ...
                    <a href="javascript:void(0);" class="btn-reject-job-applied btn-action-icon btn-action-sm reject" data-applicant_id="<?php echo esc_attr($post->ID); ?>" data-nonce="<?php echo esc_attr(wp_create_nonce( 'wp-job-board-reject-applied-nonce' )); ?>" title="<?php esc_attr_e('Reject', 'careerup'); ?>"><i class="flaticon-close"></i></a>
