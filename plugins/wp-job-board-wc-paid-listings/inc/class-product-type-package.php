...
function wp_job_board_wc_paid_listings_register_package_product_type() {
	...
	if ( class_exists( 'WC_Subscriptions' ) ) {
		class WP_Job_Board_Wc_Paid_Listings_Product_Type_Package_Subscription extends WC_Product_Subscription {
		...
		class WP_Job_Board_Wc_Paid_Listings_Product_Type_CV_Package_Subscription extends WC_Product_Subscription {
		...
		class WP_Job_Board_Wc_Paid_Listings_Product_Type_Contact_Package_Subscription extends WC_Product_Subscription {
		...
		class WP_Job_Board_Wc_Paid_Listings_Product_Type_Candidate_Package_Subscription extends WC_Product_Subscription {
		...
		class WP_Job_Board_Wc_Paid_Listings_Product_Type_Resume_Package_Subscription extends WC_Product_Subscription {
...
function wp_job_board_wc_paid_listings_add_job_package_product( $types ) {
	...
	if ( class_exists( 'WC_Subscriptions' ) ) {
		$types['job_package_subscription'] = __( 'Job Package Subscription', 'wp-job-board-wc-paid-listings' );
		$types['cv_package_subscription'] = __( 'CV Package Subscription', 'wp-job-board-wc-paid-listings' );
		$types['contact_package_subscription'] = __( 'Contact Package Subscription', 'wp-job-board-wc-paid-listings' );
		$types['candidate_package_subscription'] = __( 'Candidate Package Subscription', 'wp-job-board-wc-paid-listings' );
		$types['resume_package_subscription'] = __( 'Resume Package Subscription', 'wp-job-board-wc-paid-listings' );
	}
...
function wp_job_board_wc_paid_listings_woocommerce_product_class( $classname, $product_type ) {
    ...
    if ( class_exists( 'WC_Subscriptions' ) ) {
	    if ( $product_type == 'job_package_subscription' ) { // notice the checking here.
	        $classname = 'WP_Job_Board_Wc_Paid_Listings_Product_Type_Package_Subscription';
	    }

	    if ( $product_type == 'cv_package_subscription' ) { // notice the checking here.
	        $classname = 'WP_Job_Board_Wc_Paid_Listings_Product_Type_CV_Package_Subscription';
	    }

	    if ( $product_type == 'contact_package_subscription' ) { // notice the checking here.
	        $classname = 'WP_Job_Board_Wc_Paid_Listings_Product_Type_Contact_Package_Subscription';
	    }

	    if ( $product_type == 'candidate_package_subscription' ) { // notice the checking here.
	        $classname = 'WP_Job_Board_Wc_Paid_Listings_Product_Type_Candidate_Package_Subscription';
	    }

	    if ( $product_type == 'resume_package_subscription' ) { // notice the checking here.
	        $classname = 'WP_Job_Board_Wc_Paid_Listings_Product_Type_Resume_Package_Subscription';
	    }
    }
    return $classname;
}
...
add_filter( 'woocommerce_subscription_product_types', 'wp_job_board_wc_paid_listings_woocommerce_subscription_product_types' );
function wp_job_board_wc_paid_listings_woocommerce_subscription_product_types( $types ) {
...
add_action( 'woocommerce_product_options_general_product_data', 'wp_job_board_wc_paid_listings_package_options_product_tab_content' );
...
function wp_job_board_wc_paid_listings_package_options_product_tab_content() {
		...
		<?php
			if ( class_exists( 'WC_Subscriptions' ) ) {
				woocommerce_wp_select( array(
					...
					'label' => __( 'Subscription Type', 'wp-job-board-wc-paid-listings' ),
					'description' => __( 'Choose how subscriptions affect this package', 'wp-job-board-wc-paid-listings' ),
					'value' => get_post_meta( $post_id, '_job_package_subscription_type', true ),
					'desc_tip' => true,
					'options' => array(
						'package' => __( 'Link the subscription to the package (renew listing limit every subscription term)', 'wp-job-board-wc-paid-listings' ),
						'listing' => __( 'Link the subscription to posted listings (renew posted listings every subscription term)', 'wp-job-board-wc-paid-listings' )
					),
	...
	<div class="options_group show_if_resume_package show_if_resume_package_subscription">
		<?php
			...
			woocommerce_wp_checkbox( array(
				'id' 		=> '_urgent_resumes',
				'label' 	=> __( 'Urgent Resumes?', 'wp-job-board-wc-paid-listings' ),
				'description'	=> __( 'Urgent this listing - it will be styled differently and sticky.', 'wp-job-board-wc-paid-listings' ),
			) );
			woocommerce_wp_checkbox( array(
				'id' 		=> '_featured_resumes',
				'label' 	=> __( 'Featured Resumes?', 'wp-job-board-wc-paid-listings' ),
				'description'	=> __( 'Feature this listing - it will be styled differently and sticky.', 'wp-job-board-wc-paid-listings' ),
			) );
			woocommerce_wp_text_input( array(
...
add_action( 'woocommerce_process_product_meta_job_package_subscription', 'wp_job_board_wc_paid_listings_save_package_option_field'  );
...
add_action( 'woocommerce_process_product_meta_cv_package_subscription', 'wp_job_board_wc_paid_listings_save_cv_package_option_field'  );
...
add_action( 'woocommerce_process_product_meta_contact_package_subscription', 'wp_job_board_wc_paid_listings_save_contact_package_option_field'  );
...
add_action( 'woocommerce_process_product_meta_candidate_package_subscription', 'wp_job_board_wc_paid_listings_save_candidate_package_option_field'  );
...
add_action( 'woocommerce_process_product_meta_resume_package_subscription', 'wp_job_board_wc_paid_listings_save_resume_package_option_field'  );