...
class WP_Job_Board_Shortcodes {
	...
	public static function login( $atts ) {
		...
		return WP_Job_Board_Template_Loader::get_template_part( 'misc/login', $atts );
	}
	...
	public static function register( $atts ) {
		...
		return WP_Job_Board_Template_Loader::get_template_part( 'misc/register', $atts );
	}
	...
	public static function jobs( $atts ) {
		...
		if ( WP_Job_Board_Job_Filter::has_filter() ) {
			$params = $_GET;
		} elseif (WP_Job_Board_Abstract_Filter::has_filter($atts)) {
			$params = $atts;
		}
