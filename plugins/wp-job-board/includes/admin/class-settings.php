...
class WP_Job_Board_Settings {
	...
	public function __construct() {
		...
		add_action( 'cmb2_render_wp_job_board_hidden', 'wp_job_board_hidden_callback', 10, 5 );
	...
	public function wp_job_board_settings( $active_tab ) {
					...
					array(
						...
						'options' => array(
							'streets-v11' => array(
		                        ...
		                        'img' => WP_JOB_BOARD_PLUGIN_URL . '/assets/images/streets.png'
		                    ),
		                    'light-v10' => array(
		                        'alt' => esc_html__('light', 'wp-job-board'),
		                        'img' => WP_JOB_BOARD_PLUGIN_URL . '/assets/images/light.png'
		                    ),
		                    'dark-v10' => array(
		                        'alt' => esc_html__('dark', 'wp-job-board'),
		                        'img' => WP_JOB_BOARD_PLUGIN_URL . '/assets/images/dark.png'
		                    ),
		                    'outdoors-v11' => array(
		                        'alt' => esc_html__('outdoors', 'wp-job-board'),
		                        'img' => WP_JOB_BOARD_PLUGIN_URL . '/assets/images/outdoors.png'
		                    ),
		                    'satellite-v9' => array(
		                        'alt' => esc_html__('satellite', 'wp-job-board'),
		                        'img' => WP_JOB_BOARD_PLUGIN_URL . '/assets/images/satellite.png'
		                    ),
		                ),
		                'default' => 'streets-v11',
					),
		...
		$wp_job_board_settings['pages'] = array(
			...
			'fields'     => apply_filters( 'wp_job_board_settings_pages', array(
					...
					array(
						'name'    => __( 'After Login Page (Employer)', 'wp-job-board' ),
						'desc'    => __( 'This lets the plugin know the page after employer login/register.', 'wp-job-board' ),
					...
					array(
						'name'    => __( 'After Login Page (Candidate)', 'wp-job-board' ),
						'desc'    => __( 'This lets the plugin know the page after candidate login/register.', 'wp-job-board' ),
		...
		$wp_job_board_settings['jobs_settings'] = array(
			...
			'fields'     => apply_filters( 'wp_job_board_settings_jobs_settings', array(
				...
				array(
					...
					'type' => 'wp_job_board_title',
					'id'   => 'wp_job_board_title_jobs_settings_1',
					'before_row' => '<hr>',
					'after_row'  => '<hr>'
				),
				array(
				...
				array(
					...
					'options' => apply_filters( 'wp-job-board-restrict-job-detail', array(
						...
						'register_candidate' => __( 'Register Candidates (All registered candidates can view jobs.)', 'wp-job-board' ),
				...
				array(
					...
					'type' => 'wp_job_board_title',
					'id'   => 'wp_job_board_title_jobs_settings_fields',
					'before_row' => '<hr>',
					'after_row'  => '<hr>'
				),
				// fields
				array(
					...
					'repeatable'  		=> false,
					'options'     		=> array(
						'group_title'       => __( 'Settings', 'wp-job-board' ),
						'sortable'          => false,
						'closed'         => false,
					),
					'fields'			=> array(
				...
				array(
					'name'              => __( 'Field: Featured', 'wp-job-board' ),
					'id'                => 'job_field_featured',
					'type'              => 'group',
					'repeatable'  		=> false,
					'options'     		=> array(
						'group_title'       => __( 'Settings', 'wp-job-board' ),
				...
				array(
					'name'              => __( 'Field: Urgent Job', 'wp-job-board' ),
					'id'                => 'job_field_urgent',
					'type'              => 'group',
					'repeatable'  		=> false,
					'options'     		=> array(
				...
				array(
					'name'              => __( 'Field: Filled', 'wp-job-board' ),
					'id'                => 'job_field_filled',
					'type'              => 'group',
					'repeatable'  		=> false,
					'options'     		=> array(
				...
				array(
					'name'              => __( 'Field: Featured Image', 'wp-job-board' ),
					'id'                => 'job_field_featured_image',
					'type'              => 'group',
					'repeatable'  		=> false,
					'options'     		=> array(
						'group_title'       => __( 'Settings', 'wp-job-board' ),
				...
				array(
					'name'              => __( 'Field: Application Deadline Date', 'wp-job-board' ),
					'id'                => 'job_field_application_deadline_date',
					'type'              => 'group',
					'repeatable'  		=> false,
					'options'     		=> array(
						'group_title'       => __( 'Settings', 'wp-job-board' ),
				...
				array(
					'name'              => __( 'Field: External URL', 'wp-job-board' ),
					'id'                => 'job_field_apply_url',
					'type'              => 'group',
					'repeatable'  		=> false,
					'options'     		=> array(
						'group_title'       => __( 'Settings', 'wp-job-board' ),
				...
				array(
					'name'              => __( 'Field: Min. Salary', 'wp-job-board' ),
					'id'                => 'job_field_salary',
					'type'              => 'group',
					'repeatable'  		=> false,
					'options'     		=> array(
				...
				array(
					'name'              => __( 'Field: Max. Salary', 'wp-job-board' ),
					'id'                => 'job_field_max_salary',
					'type'              => 'group',
					'repeatable'  		=> false,
					'options'     		=> array(
						'group_title'       => __( 'Settings', 'wp-job-board' ),
				...
				array(
					'name'              => __( 'Field: Salary Type', 'wp-job-board' ),
					'id'                => 'job_field_salary_type',
					'type'              => 'group',
					'repeatable'  		=> false,
					'options'     		=> array(
						'group_title'       => __( 'Settings', 'wp-job-board' ),
				...
				array(
					'name'              => __( 'Field: Friendly Address', 'wp-job-board' ),
					'id'                => 'job_field_address',
					'type'              => 'group',
					'repeatable'  		=> false,
					'options'     		=> array(
						'group_title'       => __( 'Settings', 'wp-job-board' ),
				...
				array(
					'name'              => __( 'Field: Maps Location', 'wp-job-board' ),
					'id'                => 'job_field_map_location',
					'type'              => 'group',
					'repeatable'  		=> false,
					'options'     		=> array(
						'group_title'       => __( 'Settings', 'wp-job-board' ),
		...
		$wp_job_board_settings['employer_settings'] = array(
			...
			'fields'     => apply_filters( 'wp_job_board_settings_employer_settings', array(
				...
				array(
					'name' => __( 'Fields settings', 'wp-job-board' ),
					'type' => 'wp_job_board_title',
					'id'   => 'wp_job_board_title_employers_settings_fields',
					'before_row' => '<hr>',
					'after_row'  => '<hr>'
				),
				...
				//fields
				array(
					'name'              => __( 'Field: Employer Title', 'wp-job-board' ),
					'id'                => 'employer_field_title',
					'type'              => 'group',
					'repeatable'  		=> false,
					'options'     		=> array(
						'group_title'       => __( 'Settings', 'wp-job-board' ),
				...
				array(
					'name'              => __( 'Field: Employer Description', 'wp-job-board' ),
					'id'                => 'employer_field_description',
					'type'              => 'group',
					'repeatable'  		=> false,
					'options'     		=> array(
						'group_title'       => __( 'Settings', 'wp-job-board' ),
				...
				array(
					'name'              => __( 'Field: Employer Featured', 'wp-job-board' ),
					'id'                => 'employer_field_featured',
					'type'              => 'group',
					'repeatable'  		=> false,
					'options'     		=> array(
						'group_title'       => __( 'Settings', 'wp-job-board' ),
				...
				array(
					'name'              => __( 'Field: Profile url', 'wp-job-board' ),
					'id'                => 'employer_field_profile_url',
					'type'              => 'group',
					'repeatable'  		=> false,
					'options'     		=> array(
						'group_title'       => __( 'Settings', 'wp-job-board' ),
				...
				array(
					'name'              => __( 'Field: Logo Image', 'wp-job-board' ),
					'id'                => 'employer_field_featured_image',
					'type'              => 'group',
					'repeatable'  		=> false,
					'options'     		=> array(
						'group_title'       => __( 'Settings', 'wp-job-board' ),
				...
				array(
					'name'              => __( 'Field: Employer Categories', 'wp-job-board' ),
					'id'                => 'employer_field_category',
					'type'              => 'group',
					'repeatable'  		=> false,
					'options'     		=> array(
						'group_title'       => __( 'Settings', 'wp-job-board' ),
				...
				array(
					'name'              => __( 'Field: Employer Locations', 'wp-job-board' ),
					'id'                => 'employer_field_location',
					'type'              => 'group',
					'repeatable'  		=> false,
					'options'     		=> array(
						'group_title'       => __( 'Settings', 'wp-job-board' ),
				...
				array(
					'name'              => __( 'Field: Employer Email', 'wp-job-board' ),
					'id'                => 'employer_field_email',
					'type'              => 'group',
					'repeatable'  		=> false,
					'options'     		=> array(
						'group_title'       => __( 'Settings', 'wp-job-board' ),
				...
				array(
					'name'              => __( 'Field: Employer Founded Date', 'wp-job-board' ),
					'id'                => 'employer_field_founded_date',
					'type'              => 'group',
					'repeatable'  		=> false,
					'options'     		=> array(
						'group_title'       => __( 'Settings', 'wp-job-board' ),
				...
				array(
					'name'              => __( 'Field: Employer Website', 'wp-job-board' ),
					'id'                => 'employer_field_website',
					'type'              => 'group',
					'repeatable'  		=> false,
					'options'     		=> array(
						'group_title'       => __( 'Settings', 'wp-job-board' ),
				...
				array(
					'name'              => __( 'Field: Employer Phone', 'wp-job-board' ),
					'id'                => 'employer_field_phone',
					'type'              => 'group',
					'repeatable'  		=> false,
					'options'     		=> array(
						'group_title'       => __( 'Settings', 'wp-job-board' ),
				...
				array(
					'name'              => __( 'Field: Employer Cover Photo', 'wp-job-board' ),
					'id'                => 'employer_field_cover_photo',
					'type'              => 'group',
					'repeatable'  		=> false,
					'options'     		=> array(
						'group_title'       => __( 'Settings', 'wp-job-board' ),
				...
				array(
					'name'              => __( 'Field: Employer Profile Photos', 'wp-job-board' ),
					'id'                => 'employer_field_profile_photos',
					'type'              => 'group',
					'repeatable'  		=> false,
					'options'     		=> array(
						'group_title'       => __( 'Settings', 'wp-job-board' ),
				...
				array(
					'name'              => __( 'Field: Employer Introduction Video URL', 'wp-job-board' ),
					'id'                => 'employer_field_video_url',
					'type'              => 'group',
					'repeatable'  		=> false,
					'options'     		=> array(
						'group_title'       => __( 'Settings', 'wp-job-board' ),
					...
					'fields'			=> array(
						...
						array(
							...
							'id'        => 'title',
							'type'      => 'text',
							'default'	=> 'Introduction Video URL'
						),
						array(
							'name'      => __( 'Placeholder', 'wp-job-board' ),
							'id'        => 'placeholder',
				...
				array(
					'name'              => __( 'Field: Employer Socials', 'wp-job-board' ),
					'id'                => 'employer_field_socials',
					'type'              => 'group',
					'repeatable'  		=> false,
					'options'     		=> array(
						'group_title'       => __( 'Settings', 'wp-job-board' ),
				...
				array(
					'name'              => __( 'Field: Employer Friendly Address', 'wp-job-board' ),
					'id'                => 'employer_field_address',
					'type'              => 'group',
					'repeatable'  		=> false,
					'options'     		=> array(
						'group_title'       => __( 'Settings', 'wp-job-board' ),
				...
				array(
					'name'              => __( 'Field: Employer Maps Location', 'wp-job-board' ),
					'id'                => 'employer_field_map_location',
					'type'              => 'group',
					'repeatable'  		=> false,
					'options'     		=> array(
						'group_title'       => __( 'Settings', 'wp-job-board' ),
				...
				array(
					'name'              => __( 'Field: Employer Team Members', 'wp-job-board' ),
					'id'                => 'employer_field_team_members',
					'type'              => 'group',
					'repeatable'  		=> false,
					'options'     		=> array(
						'group_title'       => __( 'Settings', 'wp-job-board' ),
				...
				array(
					'name'              => __( 'Field: Employer Employees', 'wp-job-board' ),
					'id'                => 'employer_field_employees',
					'type'              => 'group',
					'repeatable'  		=> false,
					'options'     		=> array(
						'group_title'       => __( 'Settings', 'wp-job-board' ),
		...
		$wp_job_board_settings['candidate_settings'] = array(
			...
			'fields'     => apply_filters( 'wp_job_board_settings_candidate_settings', array(
				...
				array(
					'name' => __( 'Fields settings', 'wp-job-board' ),
					'type' => 'wp_job_board_title',
					'id'   => 'wp_job_board_title_candidates_settings_fields',
					'before_row' => '<hr>',
					'after_row'  => '<hr>'
				),
				// fields
				array(
					'name'              => __( 'Field: Candidate Title', 'wp-job-board' ),
					'id'                => 'candidate_field_title',
					'type'              => 'group',
					'repeatable'  		=> false,
					'options'     		=> array(
						'group_title'       => __( 'Settings', 'wp-job-board' ),
				...
				array(
					'name'              => __( 'Field: Candidate Description', 'wp-job-board' ),
					'id'                => 'candidate_field_description',
					'type'              => 'group',
					'repeatable'  		=> false,
					'options'     		=> array(
						'group_title'       => __( 'Settings', 'wp-job-board' ),
				...
				array(
					'name'              => __( 'Field: Candidate Featured', 'wp-job-board' ),
					'id'                => 'candidate_field_featured',
					'type'              => 'group',
					'repeatable'  		=> false,
					'options'     		=> array(
						'group_title'       => __( 'Settings', 'wp-job-board' ),
				...
				array(
					'name'              => __( 'Field: Candidate Urgent', 'wp-job-board' ),
					'id'                => 'candidate_field_urgent',
					'type'              => 'group',
					'repeatable'  		=> false,
					'options'     		=> array(
						'group_title'       => __( 'Settings', 'wp-job-board' ),
				...
				array(
					'name'              => __( 'Field: Profile url', 'wp-job-board' ),
					'id'                => 'candidate_field_profile_url',
					'type'              => 'group',
					'repeatable'  		=> false,
					'options'     		=> array(
						'group_title'       => __( 'Settings', 'wp-job-board' ),
				...
				array(
					'name'              => __( 'Field: Featured Image', 'wp-job-board' ),
					'id'                => 'candidate_field_featured_image',
					'type'              => 'group',
					'repeatable'  		=> false,
					'options'     		=> array(
						'group_title'       => __( 'Settings', 'wp-job-board' ),
				...
				array(
					'name'              => __( 'Field: Candidate Categories', 'wp-job-board' ),
					'id'                => 'candidate_field_category',
					'type'              => 'group',
					'repeatable'  		=> false,
					'options'     		=> array(
						'group_title'       => __( 'Settings', 'wp-job-board' ),
				...
				array(
					'name'              => __( 'Field: Candidate Locations', 'wp-job-board' ),
					'id'                => 'candidate_field_location',
					'type'              => 'group',
					'repeatable'  		=> false,
					'options'     		=> array(
						'group_title'       => __( 'Settings', 'wp-job-board' ),
				...
				array(
					'name'              => __( 'Field: Candidate Tags', 'wp-job-board' ),
					'id'                => 'candidate_field_tag',
					'type'              => 'group',
					'repeatable'  		=> false,
					'options'     		=> array(
						'group_title'       => __( 'Settings', 'wp-job-board' ),
				...
				array(
					'name'              => __( 'Field: Candidate Email', 'wp-job-board' ),
					'id'                => 'candidate_field_email',
					'type'              => 'group',
					'repeatable'  		=> false,
					'options'     		=> array(
						'group_title'       => __( 'Settings', 'wp-job-board' ),
				...
				array(
					'name'              => __( 'Field: Show my profile', 'wp-job-board' ),
					'id'                => 'candidate_field_show_profile',
					'type'              => 'group',
					'repeatable'  		=> false,
					'options'     		=> array(
						'group_title'       => __( 'Settings', 'wp-job-board' ),
				...
				array(
					'name'              => __( 'Field: Date of Birth', 'wp-job-board' ),
					'id'                => 'candidate_field_founded_date',
					'type'              => 'group',
					'repeatable'  		=> false,
					'options'     		=> array(
						'group_title'       => __( 'Settings', 'wp-job-board' ),
				...
				array(
					'name'              => __( 'Field: Candidate Phone', 'wp-job-board' ),
					'id'                => 'candidate_field_phone',
					'type'              => 'group',
					'repeatable'  		=> false,
					'options'     		=> array(
						'group_title'       => __( 'Settings', 'wp-job-board' ),
				...
				array(
					'name'              => __( 'Field: Candidate Job Title', 'wp-job-board' ),
					'id'                => 'candidate_field_job_title',
					'type'              => 'group',
					'repeatable'  		=> false,
					'options'     		=> array(
						'group_title'       => __( 'Settings', 'wp-job-board' ),
				...
				array(
					'name'              => __( 'Field: Candidate Salary', 'wp-job-board' ),
					'id'                => 'candidate_field_salary',
					'type'              => 'group',
					'repeatable'  		=> false,
					'options'     		=> array(
						'group_title'       => __( 'Settings', 'wp-job-board' ),
				...
				array(
					'name'              => __( 'Field: Candidate Salary Type', 'wp-job-board' ),
					'id'                => 'candidate_field_salary_type',
					'type'              => 'group',
					'repeatable'  		=> false,
					'options'     		=> array(
						'group_title'       => __( 'Settings', 'wp-job-board' ),
				...
				array(
					'name'              => __( 'Field: Candidate Portfolio Photos', 'wp-job-board' ),
					'id'                => 'candidate_field_portfolio_photos',
					'type'              => 'group',
					'repeatable'  		=> false,
					'options'     		=> array(
						'group_title'       => __( 'Settings', 'wp-job-board' ),
				...
				array(
					'name'              => __( 'Field: Candidate CV Attachment', 'wp-job-board' ),
					'id'                => 'candidate_field_cv_attachment',
					'type'              => 'group',
					'repeatable'  		=> false,
					'options'     		=> array(
						'group_title'       => __( 'Settings', 'wp-job-board' ),
				...
				array(
					'name'              => __( 'Field: Candidate Introduction Video URL', 'wp-job-board' ),
					'id'                => 'candidate_field_video_url',
					'type'              => 'group',
					'repeatable'  		=> false,
					'options'     		=> array(
						'group_title'       => __( 'Settings', 'wp-job-board' ),
				...
				array(
					'name'              => __( 'Field: Candidate Socials', 'wp-job-board' ),
					'id'                => 'candidate_field_socials',
					'type'              => 'group',
					'repeatable'  		=> false,
					'options'     		=> array(
						'group_title'       => __( 'Settings', 'wp-job-board' ),
				...
				array(
					'name'              => __( 'Field: Candidate Friendly Address', 'wp-job-board' ),
					'id'                => 'candidate_field_address',
					'type'              => 'group',
					'repeatable'  		=> false,
					'options'     		=> array(
						'group_title'       => __( 'Settings', 'wp-job-board' ),
				...
				array(
					'name'              => __( 'Field: Candidate Maps Location', 'wp-job-board' ),
					'id'                => 'candidate_field_map_location',
					'type'              => 'group',
					'repeatable'  		=> false,
					'options'     		=> array(
						'group_title'       => __( 'Settings', 'wp-job-board' ),
				...
				array(
					'name'              => __( 'Field: Candidate Education', 'wp-job-board' ),
					'id'                => 'candidate_field_education',
					'type'              => 'group',
					'repeatable'  		=> false,
					'options'     		=> array(
						'group_title'       => __( 'Settings', 'wp-job-board' ),
				...
				array(
					'name'              => __( 'Field: Candidate Experience', 'wp-job-board' ),
					'id'                => 'candidate_field_experience',
					'type'              => 'group',
					'repeatable'  		=> false,
					'options'     		=> array(
						'group_title'       => __( 'Settings', 'wp-job-board' ),
				...
				array(
					'name'              => __( 'Field: Candidate Award', 'wp-job-board' ),
					'id'                => 'candidate_field_award',
					'type'              => 'group',
					'repeatable'  		=> false,
					'options'     		=> array(
						'group_title'       => __( 'Settings', 'wp-job-board' ),
				...
				array(
					'name'              => __( 'Field: Candidate Skill', 'wp-job-board' ),
					'id'                => 'candidate_field_skill',
					'type'              => 'group',
					'repeatable'  		=> false,
					'options'     		=> array(
						'group_title'       => __( 'Settings', 'wp-job-board' ),
		...
		// ReCaaptcha
		$wp_job_board_settings['recaptcha_api_settings'] = array(
			'id'         => 'options_page',
			'wp_job_board_title' => __( 'reCaptcha API', 'wp-job-board' ),
			'show_on'    => array( 'key' => 'options-page', 'value' => array( $this->key, ), ),
			'fields'     => apply_filters( 'wp_job_board_settings_recaptcha_api_settings', array(
					array(
						'name' => __( 'Google reCAPTCHA API Settings', 'wp-job-board' ),
						'type' => 'wp_job_board_title',
						'id'   => 'wp_job_board_title_recaptcha_settings_google_recaptcha',
						'before_row' => '<hr>',
						'after_row'  => '<hr>',
		...
		// Indeed Jobs Import
		$employers = array( '' => __('Choose an employer', 'wp-job-board') );
		if ( is_admin() ) {
...
function wp_job_board_hidden_callback( $field_object, $escaped_value, $object_id, $object_type, $field_type_object ) {
	$id                = $field_type_object->field->args['id'];
	$title             = $field_type_object->field->args['name'];
	$field_description = $field_type_object->field->args['desc'];
