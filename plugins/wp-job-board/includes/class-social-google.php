...
class WP_Job_Board_Social_Google {
    ...
    public function __construct() {
        ...
        if ( $this->is_google_login_enabled() || $this->is_google_apply_enabled() ) {
            ...
            // Ajax endpoints.
            add_action( 'wjb_ajax_wp_job_board_google_login', array( $this, 'process_google_login' ) );
    ...
    private function login_user() {
        ...
        WP_Job_Board_Mixes::redirect($this->after_login_redirect_url);
    }
    ...
    public function display_login_btn() {
        ...
        <div class="google-login-btn-wrapper">
            <a class="google-login-btn google-login-new" href="<?php echo esc_url($this->get_login_url()); ?>">
                <img src="<?php echo esc_url(WP_JOB_BOARD_PLUGIN_URL.'assets/images/btn_google_signin.png'); ?>" alt="google">
            </a>
        </div>
        <?php
        $output = ob_get_clean();
    ...
    public function display_apply_btn($job) {
        ...
        <?php
        $output = ob_get_clean();
        echo apply_filters('wp-job-board-google-apply-btn', $output, $this, $job);
    }
