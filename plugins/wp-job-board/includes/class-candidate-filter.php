...
class WP_Job_Board_Candidate_Filter extends WP_Job_Board_Abstract_Filter {
	...
	public static function get_fields() {
		...
		if ( empty($option['enable']) || $option['enable'] == 'on' ) {
			$fields['category'] = array(
				'label' => !empty($option['filter_title']) ? $option['filter_title'] : __( 'Candidate Category', 'wp-job-board' ),
		...
		return apply_filters( 'wp-job-board-default-candidate-filter-fields', $fields );
	}
	...
	public static function get_query_var_filter($query_vars, $params) {
		...
		if ( ! empty( $params['filter-title'] ) ) {
			...
			$wp_job_board_candidate_keyword = sanitize_text_field( wp_unslash($params['filter-title']) );
