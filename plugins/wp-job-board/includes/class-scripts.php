...
class WP_Job_Board_Scripts {
	...
	public static function enqueue_frontend() {
		...
		wp_register_script( 'wpjb-select2', WP_JOB_BOARD_PLUGIN_URL . 'assets/js/select2/select2.full.min.js', array( 'jquery'  ), '4.0.5', true );
		wp_localize_script( 'wpjb-select2', 'wp_job_board_select2_opts', $select2_args);
		wp_register_style( 'wpjb-select2', WP_JOB_BOARD_PLUGIN_URL . 'assets/js/select2/select2.min.css', array(), '4.0.5' );
		...
		wp_localize_script( 'wp-job-board-main', 'wp_job_board_opts', apply_filters('wp-job-board-script-options', array(
			...
			'after_register_page_url' => esc_url( $after_login_page_url ),
			'after_login_page_candidate_url' => esc_url( $after_login_page_candidate_url ),
			'after_register_page_candidate_url' => esc_url( $after_login_page_candidate_url ),
			...
			'recaptcha_enable' => WP_Job_Board_Recaptcha::is_recaptcha_enabled()
		)));
