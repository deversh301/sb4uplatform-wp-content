...
class WP_Job_Board_CMB2_Field_Taxonomy_Location {
	...
	public function __construct() {
		...
		// Ajax endpoints.
		add_action( 'wjb_ajax_wpjb_process_change_location', array( $this, 'process_change_location' ) );
	...
	public function setup_admin_scripts() {
		...
		wp_enqueue_script( 'wpjb-taxonomy-location-script', $asset_path . '/js/script.js', array( 'cmb2-scripts', 'wpjb-select2', 'jquery-ui-sortable' ), self::VERSION );
		...
		wp_enqueue_style( 'wpjb-taxonomy-location-style', $asset_path . '/css/style.css', array( 'wpjb-select2' ), self::VERSION );
	}
