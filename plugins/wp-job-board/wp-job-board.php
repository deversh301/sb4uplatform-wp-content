...
if ( !class_exists("WP_Job_Board") ) {
	...
	final class WP_Job_Board {
		...
		public function setup_constants(){
			define( 'WP_JOB_BOARD_PLUGIN_VERSION', '2.3.11' );
		...
		public function includes() {
			...
			require_once WP_JOB_BOARD_PLUGIN_DIR . 'includes/class-ajax.php';
			...
			// wmpl
			require_once WP_JOB_BOARD_PLUGIN_DIR . 'includes/3rd-party/class-wpml.php';
			require_once WP_JOB_BOARD_PLUGIN_DIR . 'includes/3rd-party/class-polylang.php';
			require_once WP_JOB_BOARD_PLUGIN_DIR . 'includes/3rd-party/class-yoast.php';
			require_once WP_JOB_BOARD_PLUGIN_DIR . 'includes/3rd-party/class-jetpack.php';
			require_once WP_JOB_BOARD_PLUGIN_DIR . 'includes/3rd-party/class-all-in-one-seo-pack.php';
		...
		public function plugin_update() {
	        require_once WP_JOB_BOARD_PLUGIN_DIR . 'libraries/plugin-update-checker/plugin-update-checker.php';
	        Puc_v4_Factory::buildUpdateChecker(
	            'https://www.apusthemes.com/themeplugins/wp-job-board.json',
	            __FILE__,
	            'wp-job-board'
	        );
	    }
		...
		public static function register_post_statuses() {
			...
			register_post_status(
				'pending_payment',
				array(
					'label'                     => _x( 'Pending Payment', 'post status', 'wp-job-board' ),
					'public'                    => false,
					'exclude_from_search'       => true,
					'show_in_admin_all_list'    => false,
					'show_in_admin_status_list' => true,
					'label_count'               => _n_noop( 'Pending Payment <span class="count">(%s)</span>', 'Pending Payment <span class="count">(%s)</span>', 'wp-job-board' ),
				)
			);
			register_post_status(
				'denied',
